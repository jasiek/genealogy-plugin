...
`$XDG_CACHE_HOME/genealogy-mcp/geneteka_regions.json` (falling back to
`~/.cache/genealogy-mcp/...`). Format:
...
from genealogy_mcp.sources.geneteka.constants import REGIONS as FALLBACK_REGIONS

if TYPE_CHECKING:
    from genealogy_mcp.sources.geneteka.client import GenetekaClient
...
def default_cache_path() -> Path:
    ...
    return Path(base) / "genealogy-mcp" / "geneteka_regions.json"
