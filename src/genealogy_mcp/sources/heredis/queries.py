...
from genealogy_mcp.sources.heredis.constants import (
    BIRTH_EVENT_TYPES,
    DEATH_EVENT_TYPES,
    EVENT_TYPE_LABELS,
    UNION_TYPE_LABELS,
...
from genealogy_mcp.sources.heredis.models import (
    EventDetail,
    EventSearchResult,
    EventSummary,
    FamilyView,
...
def search_persons(
    ...
    *,
    ...
    if sex:
        from genealogy_mcp.sources.heredis.constants import SEX_TO_CODE
